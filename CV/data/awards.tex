...
\cvhonor
{FONDECYT Iniciación grant} % Award
{Chilean Science Foundation (ANID).} % Event
{Chile} % Location
{2025-2028} % Date(s)
{Application ranked 3rd out of 48 applicants in the Mathematics group.} % Description
%---------------------------------------------------------

 \cvhonor
 {Richard Rado Prize nominee} % Award
 {Discrete Mathematics Section of the German Mathemtical Society.} % Event
...
%  
 ...
 {Berlin, Germany} % Location
 {2023} % Date(s)
 {Awarded to at most three mathematics and applications dissertations in Berlin each year.} % Description
%  
%---------------------------------------------------------
  \cvhonor
