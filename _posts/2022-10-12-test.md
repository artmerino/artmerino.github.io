...
sagecell.makeSagecell({inputLocation:  '#mycell',
                        autoeval = true,
                        hide: ["evalButton","editor","fullScreen","language","done","sessionFiles"]});
</script>
</head>
...
@interact
def _(prob=slider(0,1,default=0.5,step_size=0.05), n=selector([2,3,4],default=4)):
    draw_random_polytope(p=prob,d=n)
</script></div>
