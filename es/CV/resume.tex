...
\input{data/presentation-long.tex}

\input{data/teaching.tex}

\input{data/language_skills.tex}

\input{data/attended.tex}

\input{data/service.tex}

% \input{data/references.tex}

% \input{data/computer_skills.tex}

% \input{data/coauthors.tex}

% \input{data/relevance.tex}
