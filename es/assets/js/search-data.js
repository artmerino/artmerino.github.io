...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/es/";
          ...
          description: "",
          section: "Noticias",},{id: "news-visita-de-investigación-a-la-universidad-de-kassel",
          ...
          description: "",
          section: "Noticias",},{id: "news-presenté-una-charla-sobre-nuestro-paper-listing-faces-of-polytopes-en-el-workshop-on-optimization-and-algorithms",
          title: 'Presenté una charla sobre nuestro paper “Listing Faces of Polytopes” en el Workshop...',
          description: "",
          ...
          description: "with background image",
          section: "Proyectos",handler: () => {
              window.location.href = "/es/projects/es/1_project%20copy/";
            },},{id: "projects-project-2",
          title: 'project 2',
          description: "a project with a background image and giscus comments",
          section: "Proyectos",handler: () => {
              window.location.href = "/es/projects/es/2_project%20copy/";
            },},{id: "projects-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Proyectos",handler: () => {
              window.location.href = "/es/projects/es/3_project%20copy/";
            },},{id: "projects-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Proyectos",handler: () => {
              window.location.href = "/es/projects/es/4_project%20copy/";
            },},{id: "projects-project-5",
          title: 'project 5',
          description: "a project with a background image",
          section: "Proyectos",handler: () => {
              window.location.href = "/es/projects/es/5_project%20copy/";
